...
GISAID_H3N2 <- build_GISAID("C:/Users/19177/Desktop/Flu_Data/Protein/H3N2/All.fasta",
                            type='H3N2',seq_type = "AA")
GISAID_H1N1 <- build_GISAID("C:/Users/19177/Desktop/Flu_Data/Protein/H1N1/All.fasta",
                            type='H1N1',seq_type = "AA")
write.csv(GISAID_H3N2[[1]],"C:/Users/19177/Desktop/Flu_Data/H3N2_GISAID.csv")
write.csv(GISAID_H1N1[[1]],"C:/Users/19177/Desktop/Flu_Data/H1N1_GISAID.csv")

## 2. Read WHO HI table -> remove Test rows -> extract A/..../YYYY part
WHO_H3N2_TB <- read_WHO_xlsx("C:/Users/19177/Desktop/Flu_Data/Assay/H3N2.xlsx")
WHO_H3N2 <-
  clean_TB(WHO_H3N2_TB) %>%
  clean_Mutation()
WHO_H1N1_TB <- read_WHO_xlsx("C:/Users/19177/Desktop/Flu_Data/Assay/H1N1 (no H1N2 tag).xlsx")
WHO_H1N1 <-
...
## 8. Save table
write.csv(H3N2_final,file = "C:/Users/19177/Desktop/Flu_Data/H3N2.csv",row.names = FALSE)
write.csv(H1N1_final,file = "C:/Users/19177/Desktop/Flu_Data/H1N1.csv",row.names = FALSE)

## 9. Generate json file
Generate_json(H3N2_final,GISAID_H3N2,"C:/Users/19177/Desktop/Flu_Data/H3N2")
Generate_json(H1N1_final,GISAID_H1N1,"C:/Users/19177/Desktop/Flu_Data/H1N1")
